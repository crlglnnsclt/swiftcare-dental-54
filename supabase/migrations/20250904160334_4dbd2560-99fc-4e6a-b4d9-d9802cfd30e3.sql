...
-- Insert sample treatments/services (without description field)
...
INSERT INTO public.treatments (id, name, default_duration_minutes, default_price, is_global_template, created_by_super_admin, service_code)
VALUES 
  ('tg111111-1111-1111-1111-111111111111', 'Emergency Consultation', 30, 120.00, true, true, 'EMERGENCY'),
  ('tg222222-2222-2222-2222-222222222222', 'Teeth Whitening', 60, 300.00, true, true, 'WHITENING'),
  ('tg333333-3333-3333-3333-333333333333', 'Orthodontic Consultation', 45, 150.00, true, true, 'ORTHO_CONS')
ON CONFLICT (id) DO NOTHING;