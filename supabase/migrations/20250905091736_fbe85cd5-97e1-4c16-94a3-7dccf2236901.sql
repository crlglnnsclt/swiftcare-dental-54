...
BEGIN
    ...
    INSERT INTO queue (appointment_id, position, status, estimated_wait_time, called_at, notes)
    VALUES 
        (sample_appointment_id_1, 1, 'waiting', 15, NULL, 'Regular cleaning'),
        (sample_appointment_id_2, 2, 'called', 5, NOW() - interval '5 minutes', 'Dental consultation'),
        (sample_appointment_id_3, 3, 'waiting', 25, NULL, 'Root canal treatment');
