...
export default function ManagerForms() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/10 to-secondary/5 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        <h1 className="text-3xl font-bold text-foreground">Compliance & Documentation</h1>
        <Card className="glass-card">
          <CardHeader><CardTitle>Regulatory Management</CardTitle></CardHeader>
